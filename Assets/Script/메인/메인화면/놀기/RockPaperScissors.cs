...
public class RockPaperScissors : MonoBehaviour
{
    ...
    IEnumerator tempGageUpCoroutine;
    void GageUp(float num)
    {
        if (tempGageUpCoroutine != null)
        {
            StopCoroutine(tempGageUpCoroutine);
        }
        tempGageUpCoroutine = GageUpCoroutine(num);
        StartCoroutine(tempGageUpCoroutine);
    }

    IEnumerator GageUpCoroutine(float num)
    {
